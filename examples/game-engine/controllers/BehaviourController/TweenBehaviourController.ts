...
import TweenBehaviourModel from "@examples/game-engine/models/BehaviourModel/TweenBehaviourModel";
import {ComponentEvent, ComponentEvents} from "@/Component";
import TweenStepModel from "@examples/game-engine/models/BehaviourModel/TweenBehaviourModel/TweenStepModel";
import Log from "@/log";
