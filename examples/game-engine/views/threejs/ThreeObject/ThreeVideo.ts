...
import {createVideo} from "@examples/game-engine/views/common/Video";
import {schema} from "mozel";
import VideoController from "@examples/game-engine/controllers/ObjectController/VideoController";
