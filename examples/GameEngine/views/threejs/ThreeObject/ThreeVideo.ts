...
import VideoModel from "@examples/GameEngine/models/ObjectModel/VideoModel";
import Log from "@/log";
import ThreeObject from "@examples/GameEngine/views/threejs/ThreeObject";
import {createVideo} from "@examples/GameEngine/views/common/Video";
import {schema} from "mozel";
import VideoController from "@examples/GameEngine/controllers/ObjectController/VideoController";
